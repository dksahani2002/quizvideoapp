...
import { Home, PlusCircle, Settings, Film, LogOut, UploadCloud, Shield, Clapperboard, Library, ScanSearch } from 'lucide-react';
...
const links = [
  ...
  { to: '/trailer-breakdown', icon: ScanSearch, label: 'Trailer Breakdown' },
