/**
 * Default quiz-generation guidelines (topic / AI mode).
 * Keep in sync with src/constants/mcqGuidelinesDefault.ts
 */
export const DEFAULT_MCQ_GUIDELINES = `- Questions should test understanding, not definitions only
