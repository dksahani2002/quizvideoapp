 ...
 *
 * Picks cut times based on `StoryJobOptions.sceneDetectionMode`. Results feed
 * {@link buildSceneWindows} in pipeline/run.ts.
 */
import { detectSceneCutTimes } from '../render/ffmpeg.js';
import { detectSceneCutsPySceneDetect } from './pyDetect.js';
import type { StorySceneDetectionMode } from '../lib/storyOptions.js';
